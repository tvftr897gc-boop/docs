...
Pre-generation does come with a tradeoff: every generated chunk takes up disk space. **Always cap the radius of your pre-generation** so you don't fill your server's storage. We recommend a radius between **2,000 and 5,000 blocks** for most servers.
